...
#include "PrePeekPostProcessTest.h"

void checkWithoutThis() {
    ASSERT_EQUAL(1, 1);
}

PrePeekPostProcessTest::PrePeekPostProcessTest() : tpunit::TestFixture("PrePeekPostProcess",
    BEFORE_CLASS(PrePeekPostProcessTest::setup),
