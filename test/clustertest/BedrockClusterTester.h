...
public:
    ...
    ClusterTester(ClusterSize size, list<string> queries = {}, map<string, string> _args = {}, list<string> uniquePorts = {}, string pluginsToLoad = "db,cache,jobs,zstd", const string& processPath = "");
