...
public: // External API
    ...
    // escalate to master).
    void setState( SQLCState state ) { SASSERT( _readOnly ); _state = state; }
    void setMasterVersion( const string& version ) { SASSERT( _readOnly ); _masterVersion = version; }
...
private: // Internal API
    ...
    bool _majoritySubscribed( ) { int ignore; return _majoritySubscribed( ignore, ignore ); }
