...
public: // External API
  ...
  SQLite(const string &filename, int cacheSize, int autoCheckpoint,
  ...
  bool addColumn(const string &tableName, const string &column,
  ...
  uint64_t getLastTransactionTiming(uint64_t &begin, uint64_t &read,
