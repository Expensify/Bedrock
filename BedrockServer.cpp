            ...
            while (nextIt != _requestCountSocketMap.end()) {
                ...
                if (mapIt->second == s) {
                    ...
                    if (_queuedRequests.cancel("requestCount", SToStr(requestCount))) {
                        ...
                        SINFO("Cancelling abandoned request #" << requestCount
                                                               << " in queuedEscalatedRequests; was never "
                        ...
                        SWARN("Can't cancel abandoned request #"
                              << requestCount << " in processedResponses; this *was* processed by the "
                        ...
                        // possible.
                        SHMMM("Attempting to cancel abandoned request #" << requestCount
                                                                         << " being processed by some thread; it "
